# =====================================================================
# IAP × RPG — WORKED INTERACTION ANALYSIS
# Supplementary reproducibility material
#
# This script generates the complete IAP × RPG worked example used to
...
OUTPUT_FILE = "iap_rpg_worked_example.pdf"
...
def page_footer(
    ...
    fig.text(
        LEFT,
        0.026,
        "Supplementary worked example  |  IAP × RPG interaction analysis",
        fontsize=5.9,
        color=MUTED,
        ha="left"
    )
...
def render_page_1(pdf):
    ...
    page_header(
        fig,
        "Worked example: IAP × RPG interaction",
...
def render_page_8(pdf):
    ...
    page_header(
        fig,
        "Complete IAP × RPG interaction summary",
...
def render_page_9(pdf):
    ...
    page_header(
        ...
        "IAP × RPG interaction  |  All national markets"
    )
    ...
    fig.text(
        ...
        0.070,
        (
            "Each row reports the country-specific IAP × RPG interaction estimate "
...
def render_page_10(pdf):
    ...
    page_header(
        ...
        "IAP × RPG interaction  |  Install success and rating success"
    )
