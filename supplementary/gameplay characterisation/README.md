...
`conceptual_plot.png`  
Conceptual visualization associated with the gameplay-characterization analysis.

---

## Relationship to the Full Empirical Analysis

Gameplay characterization is **Stage 4 of the five-stage empirical analysis**.

The complete analytical sequence is:

1. **Stage 1 — Genre-Level Interaction Analysis**  
   Estimates pooled Ads/IAP × genre interactions.

2. **Stage 2 — Cross-Market Analysis**  
   Examines interaction profiles across 42 national Google Play markets.

3. **Stage 3 — Temporal Analysis**  
   Examines temporal stability within national markets across 14 monthly periods.

4. **Stage 4 — Gameplay Characterization**  
   Characterizes the gameplay associated with recurring positive and negative interaction profiles.

5. **Stage 5 — National-Context Analysis**  
   Examines whether cross-country variation in interaction magnitude is associated with national contextual indicators.

Stage 4 therefore provides the **gameplay-level interpretation** of the statistical interaction patterns established in the preceding stages.

---

## Reproducibility and Supporting Materials

The quantitative game-selection procedure is documented through the analysis code and profile-specific selection outputs included in this repository.

Gameplay characterization is a manual characterization stage rather than an automated statistical classification procedure. The methodology, selected-game documentation, and supporting materials are therefore provided to make the selection and characterization process transparent and auditable.

Complete game-level characterization and coding materials should be consulted alongside the main-paper summary tables when reproducing or evaluating this stage of the analysis.

---

## Terminology

**Ads** — Games containing advertising.

**IAP** — Games offering in-app purchases.

**Install success** — Binary marketplace-success measure defined relative to the country–month install distribution used in the empirical analysis.

**Interaction profile** — The direction of the monetization × genre interaction established from the additive (DDP) and multiplicative (RoR) interaction measures.

**Positive (+)** — Statistically supported positive interaction on both additive and multiplicative scales.

**Negative (−)** — Statistically supported negative interaction on both additive and multiplicative scales.

---

## Citation

When using these materials, please cite the associated research paper and repository rather than individual screenshots or intermediate files.
